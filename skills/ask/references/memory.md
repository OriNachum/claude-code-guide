...
- **Memory is project-scoped** — Claude's memories for project A don't leak into project B
...
- See [Configuring Your Claude](configuring-your-claude.md) for how configuration evolves over time
- See [Sub Agents](sub-agents.md) for how sub agents interact with memory
